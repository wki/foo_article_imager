...
in der Mitte sowie ein Logo in einer Ecke besitzt. Um erweiterbar zu sein,
erzeugen wir eine einfache Klasse (Button), in der die verwendeten Operationen
gekapselt sind. Die Erzeugung unserer Graphik sieht dann so aus:
